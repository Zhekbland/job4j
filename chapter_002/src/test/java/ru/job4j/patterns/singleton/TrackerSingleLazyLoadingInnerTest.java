...
/**
 * Testing TrackerSingleLazyLoadingInner.
 *
 * @author Evgeny Shpytev (mailto:eshpytev@mail.ru).
 * @version 1.
 * @since 27.05.2019.
 */
public class TrackerSingleLazyLoadingInnerTest {

    private TrackerSingleLazyLoadingInner trackerSingleton = TrackerSingleLazyLoadingInner.getInstance();
